...
import full from '../assests/red.png';
...
function Learnobjball() {
  ...
  useEffect(() => {
    localStorage.setItem("ball_voice_tries", "0");
    localStorage.setItem("ball_select_tries", "0");

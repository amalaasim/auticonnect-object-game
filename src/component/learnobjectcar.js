...
export function UploadShoe() {
  ...
  const handleAnotherClick = () => {
    ...
    localStorage.removeItem("uploadedCar"); // clear old image
  ...
  const handleFileChange = (e) => {
    ...
    if (file) {
      ...
      reader.onloadend = () => {
        localStorage.setItem("uploadedCar", reader.result); // consistently use uploadedCookie
      };
  ...
  const handleContinue = () => {
    ...
    if (savedImage) {
      navigate("/car", { state: { uploadedImage: savedImage } });
    }
  };
...
function Learnobjcar() {
  ...
  useEffect(() => {
    localStorage.setItem("car_voice_tries", "0");
    localStorage.setItem("car_select_tries", "0");
    localStorage.setItem("car_select_done", "false");
  }, []);
  ...
  if (savedImage) {
    ...
    navigate("/findcar"); // agar image nahi hai to find page
             ...
             sx={{
               ...
               letterSpacing:"1px",
color:"rgb(15, 21, 27,0.8)",
               "&:hover": { transform: "scale(1.08)", boxShadow: "0 10px 25px rgba(0,0,0,0)"},opacity:"0.9",
             }}>
              {t("next")}
              </Typography> 
                  </Box>
                  ...
                  >
                    ...
                    >
                      {audioFinished
                        ...
                        : speechVerified
                        ? "Verified: car ✅"
                        : `Say “car” to continue (${speechStep}/2)`}
                    </Typography>
                    {speechStatus && (
                      <Typography
                        sx={{
...
<audio
  ref={audio1Ref}
  src={i18n.language === "ur" ? repeatcarurdu : repeatCookie}
  preload="auto"
/>

<audio
  ref={audio2Ref}
  src={i18n.language === "ur" ? sayagainurdu: sayagain}
  preload="auto"
/>

<audio
  ref={audio3Ref}
  src={i18n.language === "ur" ? amazcarurdu : amazing}
  preload="auto"
/>
